...
class ContactsCompanyModel extends \Home\Model\ContactsBaseModel{
	
	protected $check_md5_str = true;
	protected $mimetype = 'organization';
	protected $mimetype_array = array('organization');
	
	public function __construct($cache_object = null,$name='',$tablePrefix='',$connection=''){
		
		$db_prefix = C('DB_PREFIX');
		$this->dbName = 'db_contacts';
		$this->tableName = $db_prefix.'contacts_company';
	...
	public function contacts_list2current_list_relation(){
		...
		$conversion_relation['data_1'] = 'company';
		$conversion_relation['data_2'] = 'type_name';
		$conversion_relation['data_3'] = 'label';
		$conversion_relation['data_4'] = 'title';
		$conversion_relation['data_5'] = 'department';
		$conversion_relation['data_6'] = 'job_description';
		$conversion_relation['data_7'] = 'symbol';
		$conversion_relation['data_8'] = 'phonetic_name';
		$conversion_relation['data_9'] = 'office_location';
		$conversion_relation['data_10'] = 'phonetic_name_style';
