...
class ContactsWebsiteModel extends \Home\Model\ContactsBaseModel {
	
	protected $check_md5_str = true;
	protected $mimetype = 'website';
	protected $mimetype_array = array('website');
	
	public function __construct($cache_object = null,$name='',$tablePrefix='',$connection=''){
		
		$db_prefix = C('DB_PREFIX');
		$this->dbName = 'db_contacts';
		$this->tableName = $db_prefix.'contacts_website';
	...
	public function contacts_list2current_list_relation(){
		...
		$conversion_relation['data_1'] = 'url';
