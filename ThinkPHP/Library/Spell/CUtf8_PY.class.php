...
class CUtf8_PY {  
    ...
    public static function encode($utf8Data, $sRetFormat='head'){
    	...
    	$aBuf = array();
        $sGBK = @iconv('UTF-8', 'GBK//ignore', $utf8Data);        
        for ($i=0, $iLoop=strlen($sGBK); $i<$iLoop; $i++) {  
            ...
            if($iChr>160){
                ...
                $iChr = ($iChr<<8) + ord($sgbk_str) - 65536;
            }
            if('head' === $sRetFormat){
    ...
    private static function zh2py($iWORD){
    	...
    	if($iWORD > 0 && $iWORD < 160 ){
        	...
        	$other_array = array('-6993'=>'liu','-8231'=>'bi','-5152'=>'tun','-2354'=>'xin','-8003'=>'du','-9286'=>'feng','-8503'=>'xi',
        	                     '-5128'=>'teng','-7761'=>'cen','-9479'=>'wu','-3652'=>'dou');
        	if(isset($other_array[$iWORD])){
        	
        		$result = $other_array[$iWORD];
        	}           
        }else{     	
